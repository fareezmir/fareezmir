...
My name is Fareez, and I'm a student at Toronto Metropolitan University (TMU) pursuing a degree in Computer Engineering. AI, Software Development, and Software Architecture are all pretty cool. 

As of right now, I'm currently building DealSense, a smart, AI powered price tracker to tell you if the item you're trying to buy is worth buying now or to wait for an incoming price drop, and to check if any sale of a current item is actually a sale, all pushed to notify you!
